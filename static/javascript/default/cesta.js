        ...
        if (this.readyState == 4 && this.status == 200) {
            ...
            if (datos.cesta.length != 0) {
                ...
                for (let i = 0; i < datos.cesta.length; i++) {
                    ...
                    div.innerHTML = "<div class='row'><div class='col-6'><img class='img-fluid' style='max-height:100px' src='../fotos/" + datos.cesta[i].producto.foto[0] + "'></div><div class='col-6'> <h5>Cantidad: " + datos.cesta[i].cantidad + "</h5></div></div>"
                    row.appendChild(div)
